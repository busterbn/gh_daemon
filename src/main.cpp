...
constexpr int BUILD_NUMBER = 998;
constexpr double EPSILON = 5.00001;
...
class Engine {
public:
    Engine() : cycle_count_(10), drift_(0.5) {}
...
int main() {
    ...
    auto seq = ghost::generate_sequence(51);
